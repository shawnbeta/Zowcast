...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'config_service' => 'getConfigServiceService',
            ...
            'episode_service' => 'getEpisodeServiceService',
            'file_locator' => 'getFileLocatorService',
            'file_service' => 'getFileServiceService',
            ...
            'subscription_service' => 'getSubscriptionServiceService',
            ...
            'utility_service' => 'getUtilityServiceService',
    ...
    /**
     * Gets the 'config_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HC\Bundle\CoreBundle\Services\ConfigService A HC\Bundle\CoreBundle\Services\ConfigService instance.
     */
    protected function getConfigServiceService()
    {
        return $this->services['config_service'] = new \HC\Bundle\CoreBundle\Services\ConfigService('args');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'zowcast', 'user' => 'zowcast', 'password' => 'mEtruv5s', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/HC/Bundle/MediaBundle/Entity'))), 'HC\\Bundle\\MediaBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('HCMediaBundle' => 'HC\\Bundle\\MediaBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_cb1e9a50e9e38528c13049f9ef8836fb0548f55b95c7ea502f314843e1657e15');
    ...
    /**
     * Gets the 'episode_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HC\Bundle\MediaBundle\Services\EpisodeService A HC\Bundle\MediaBundle\Services\EpisodeService instance.
     */
    protected function getEpisodeServiceService()
    {
        return $this->services['episode_service'] = new \HC\Bundle\MediaBundle\Services\EpisodeService('value');
    }
    ...
    /**
     * Gets the 'file_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HC\Bundle\UtilityBundle\Services\FileService A HC\Bundle\UtilityBundle\Services\FileService instance.
     */
    protected function getFileServiceService()
    {
        return $this->services['file_service'] = new \HC\Bundle\UtilityBundle\Services\FileService('args');
    }
    ...
    /**
     * Gets the 'subscription_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HC\Bundle\MediaBundle\Services\SubscriptionService A HC\Bundle\MediaBundle\Services\SubscriptionService instance.
     */
    protected function getSubscriptionServiceService()
    {
        return $this->services['subscription_service'] = new \HC\Bundle\MediaBundle\Services\SubscriptionService('value');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/HC/Bundle/MediaBundle/Resources/views'), 'HCMedia');
        $instance->addPath(($this->targetDirs[3].'/src/HC/Bundle/CoreBundle/Resources/views'), 'HCCore');
        $instance->addPath(($this->targetDirs[3].'/src/HC/Bundle/UtilityBundle/Resources/views'), 'HCUtility');
        $instance->addPath(($this->targetDirs[3].'/src/HC/Bundle/VendorBundle/Resources/views'), 'HCVendor');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('354e57d4cf548aa7af06ece70fa37c084aad81bd');
    }

    /**
     * Gets the 'utility_service' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HC\Bundle\UtilityBundle\Services\UtilityService A HC\Bundle\UtilityBundle\Services\UtilityService instance.
     */
    protected function getUtilityServiceService()
    {
        return $this->services['utility_service'] = new \HC\Bundle\UtilityBundle\Services\UtilityService('args');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('562feb6ba29f68.38833826')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'HCMediaBundle' => 'HC\\Bundle\\MediaBundle\\HCMediaBundle',
                'HCCoreBundle' => 'HC\\Bundle\\CoreBundle\\HCCoreBundle',
                'HCUtilityBundle' => 'HC\\Bundle\\UtilityBundle\\HCUtilityBundle',
                'HCVendorBundle' => 'HC\\Bundle\\VendorBundle\\HCVendorBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'zowcast',
            'database_user' => 'zowcast',
            'database_password' => 'mEtruv5s',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '354e57d4cf548aa7af06ece70fa37c084aad81bd',
            'locale' => 'en',
            ...
            'kernel.secret' => '354e57d4cf548aa7af06ece70fa37c084aad81bd',
