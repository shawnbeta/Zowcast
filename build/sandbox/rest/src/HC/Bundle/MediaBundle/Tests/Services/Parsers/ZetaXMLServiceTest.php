...
class ZetaXMLServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $src = 'http://localhost/zowcast/rest/web/xml/test11.xml';
    ...
    {
        $subscription = $zetaServiceObj->getSubscriptionArray();
    ...
    {
        $lu = 1435546770000;
        $episodeCollection = $zetaServiceObj->getEpisodeCollection($lu);
